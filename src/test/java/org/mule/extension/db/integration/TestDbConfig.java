...
import static org.mule.extension.db.integration.AbstractQueryTimeoutTestCase.QUERY_TIMEOUT_FLOW;
...
public class TestDbConfig {
   ...
   * </ul>
   */
  private static boolean USE_MSSQL_SERVER = true;
  ...
  public static List<Object[]> getSqlServerResource() {
    if (USE_MSSQL_SERVER) {
      ...
      return singletonList(new Object[] {"integration/config/mssql-config.xml", sqlServerTestDataBase,
          sqlServerTestDataBase.getDbType(), asList(QUERY_TIMEOUT_FLOW)});
    } else {
      return emptyList();
    }
  }
